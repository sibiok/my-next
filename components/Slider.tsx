...
export default function Slider() {
  ...
  return (
    <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen h-[600px] overflow-hidden">
      ...
      >
        <h2 className="uppercase text-4xl md:text-5xl font-bold mb-4">
        ...
        <Link
          href="/contact"
          className="bg-brand text-white px-6 py-2 rounded-full text-lg hover:opacity-90 transition-opacity inline-block"
        >
          Contact Us
        </Link>
      </div>
